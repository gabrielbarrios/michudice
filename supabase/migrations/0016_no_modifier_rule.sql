-- Carta de regla 'none' = "No hay variante, juega con las reglas base".
-- El Michudice cumple su obligación de jugar carta de regla pero la ronda
-- se puntúa sin modificador (igual que si no hubiera regla activa).

set search_path = public, pg_temp;

-- 1. Aceptar 'none' en round_rule_picks --------------------------------
...
-- 2. build_rule_deck con la nueva carta -------------------------------
...
-- 3. submit_rule_pick acepta 'none' -----------------------------------
...
-- 4. score_picks: normalizar 'none' a null y delegar al flujo base ----
-- Wrapper sin reescribir todo: sustituimos el parámetro por null cuando
-- llega 'none' y reusamos el cuerpo existente.
