-- Carta de regla 'double_low': el dueño de la carta única más baja suma su
-- valor multiplicado por 2. El resto de las cartas únicas suman su valor
-- nominal. La escalera funciona igual (bono al dueño de la más baja); el
-- doble del individual y el bono se acumulan.

set search_path = public, pg_temp;

-- 1. CHECK de round_rule_picks incluye 'double_low' --------------------
...
-- 3. build_rule_deck incluye 'double_low' (regla positiva) ------------
...
-- 4. score_picks con soporte para 'double_low' ------------------------
...
begin
  ...
  -- v_unique_values queda en orden ascendente (loop 3..9), así que el primer
  -- elemento es la carta única más baja. Usado por la regla 'double_low'.
