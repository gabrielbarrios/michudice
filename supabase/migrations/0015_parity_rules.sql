-- Dos cartas de regla nuevas basadas en paridad:
--   cancel_even: todas las cartas con valor par se cancelan (no suman).
--   cancel_odd : todas las cartas con valor impar se cancelan.
-- La cancelación por duplicado sigue aplicando sobre las cartas que no
-- queden canceladas por paridad.
...
-- 4. score_picks con cancelación por paridad ---------------------------
...
declare
  ...
  v_cancel_even boolean := (p_rule = 'cancel_even');
  v_cancel_odd  boolean := (p_rule = 'cancel_odd');
